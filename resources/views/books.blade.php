...
@section('content')
    ...
    <div class="card-body">
        ...
        <form action="{{ url('books') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-sm-6 offset-md-3">
                    <label for="item_image" class="col-sm-3 control-label">画像</label>
                    <input type="file" name="item_image" id="item_image" class="form-control @if($errors->has('item_image')) is-invalid @endif" value="{{ old('item_image') }}">
                    <div class="invalid-feedback">
                    ...
                    <tbody>
                        @foreach ($books as $book)
                            <tr>
                                ...
                                <td class="table-text">
                                    <div><img src="upload/{{ $book->item_image }}" width="100"></div>
                                </td>
                                <td class="table-text">
